...
data, time = pac_signals_tort(sf=sf, fpha=10, famp=100, noise=3, ntrials=n,
                              dpha=10, damp=10, npts=2000)

# First, let's use the MVL, without any further correction by surrogates :
p = Pac(fpha=(1, 20, 1, 1), famp=(60, 160, 5, 5), dcomplex='wavelet', width=12)
...
for i, k in enumerate(range(5)):
    ...
    xpac = p.fit(phases, amplitudes, axis=2, nperm=50)
    # Plot :
    plt.subplot(3, 2, k + 1)
