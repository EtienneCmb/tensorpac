...
plt.subplot(1, 2, 1)
plot(time, sig.squeeze(), 'Strong coupling between\n2hz <-> 100hz')

plt.subplot(1, 2, 2)
plot(time2, sig2.squeeze(), 'Weak and noisy coupling between\n4hz <-> 60hz')
