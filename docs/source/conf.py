...
# -*- coding: utf-8 -*-
#
# Tensorpac documentation build configuration file, created by
...
htmlhelp_basename = 'Tensorpacdoc'
...
latex_documents = [
    (master_doc, 'Tensorpac.tex', 'Tensorpac Documentation',
...
man_pages = [
    (master_doc, 'tensorpac', 'Tensorpac Documentation',
     [author], 1)
]
